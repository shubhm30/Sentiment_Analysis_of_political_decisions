...
line = "RT @shubham: NCERT to review expert working in schools 21321 323 textbooks to update 3283823 11content; may include #demonetisation #GST https://t.co/Ea9JZIKepE"
print(lemm_words(line))

with open('Demonetisation/demonet.csv', 'r') as rf, \
        open('Demonetisation/demonet_pp.csv', 'w') as wf:
    c_reader = csv.reader(rf)
    c_writer = csv.writer(wf)
    for row in c_reader:
        row = row[2]
        ...
        c_writer.writerow([st])
    # print(rem_stpwords(st_num))
